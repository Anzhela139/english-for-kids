...
class App {
    ...
    init() {
        ...
        $toggleSwitch.addEventListener('change', () => this.handleSwitchMode.bind(this));
        $menuBurgerBtn.addEventListener('click', () => this.handleMenu.bind(this));
    }
    ...
    handleMenu() {
        ...
        $menu.hidden = $menuBurgerBtn.classList.contains('menu-burger-rotate');
